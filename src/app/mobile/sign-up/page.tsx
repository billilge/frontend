  ...
  return (
    <MobileLayout>
      <section className="relative flex h-dvh w-full flex-col items-center justify-start overflow-hidden">
        <section className="mt-20 flex w-11/12 flex-col items-start text-xl font-semibold">
          <div>복지물품 대여 시스템</div>
          <div>빌릴게에 오신 것을 환영합니다!</div>
        </section>
        ...
        <button
          className="absolute bottom-7 flex w-11/12 justify-between rounded-2xl border px-6 py-4"
          type="button"
        >
